package com.robindrew.codegenerator.lang.java.generator.object.serializer.generator.xml;
...
import com.robindrew.codegenerator.lang.java.generator.object.serializer.generator.xml.method.ReadObjectMethod;
import com.robindrew.codegenerator.lang.java.generator.object.serializer.generator.xml.method.ReadObjectReturnTypeMethod;
import com.robindrew.codegenerator.lang.java.generator.object.serializer.generator.xml.method.WriteObjectMethod;
import com.robindrew.codegenerator.lang.java.generator.object.serializer.generator.xml.method.WriteObjectReturnTypeMethod;
...
public class JavaXmlSerializerGenerator extends JavaObjectGenerator {

	private final JavaModelXmlSerializer serializer;
	private IJavaType classType = null;
	private IJavaType returnTypeClassType = null;
	private JavaModelBean bean = null;

	public JavaXmlSerializerGenerator(ISetup setup, IJavaContext context, JavaModel model, JavaModelXmlSerializer serializer) {
		super(setup, context, model, serializer.get());
		this.serializer = serializer;
	}

	public JavaModelXmlSerializer getSerializer() {
		return serializer;
	}
	...
	public void registerSecondaryTypes() {
		...
		bean.setXmlSerializer(serializer);
	}
	...
	public void generate() {
		...
		object.addExtends(resolve(IXmlSerializer.class, bean.getInterfaceType()));
	...
	private void generateReturnType() {
		...
		object.addExtends(resolve(IXmlSerializer.class, bean.getReturnType().toObjectType()));
