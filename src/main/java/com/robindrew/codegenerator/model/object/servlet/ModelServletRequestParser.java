package com.robindrew.codegenerator.model.object.servlet;
...
public class ModelServletRequestParser extends SimpleModelElement implements IModelObject {
	...
	public String getName() {
		if (name == null) {
			return type + "ServletRequestParser";
		}
		return name;
	}
